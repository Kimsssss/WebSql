       ...
       $( "#sections" ).droppable({
         ...
         accept: "#createtable",
          drop: function( event, ui ) {
           ...
           //테이블 생성
           $( this ).prepend("<form action='create.htm' method='post'><table border='1' id='tbs' class='draggable' ><tbody><tr><td colspan='3'><input type='text' name='tablename"+ tableNumber +"' placeholder='테이블명'></td></tr>   <tr><td>컬럼명</td><td>데이터 타입</td><td>제약조건</td></tr><tr id='colplus'><td><input type='text' name='col"+ tableNumber +"_"+ colNumber +"'></td><td><input type='text' name='col_data"+ tableNumber +"_"+ colNumber +"'></td><td id='cons'><input type='button' id='constraint"+ tableNumber +"_"+ colNumber +"' name='constraint' value='제약설정'><input type='hidden' id='conhidden' value='constraintDialog"+ tableNumber +"_"+ colNumber +"'><input type='hidden' id='conhidden_hidden' value='constraintDialog_Dialog"+ tableNumber +"_"+ colNumber +"'><input type='hidden' id='constraints' value=''><input type='hidden' id='hidden_tableName' value=''><input type='hidden' id='hidden_colName' value=''></td></tr><tr><td colspan='3'><center><input id='sub"+ tableNumber +"' type='button' value='전송' style='width: 100px;'> <input type='button' id='plus"+ tableNumber +"' value='추가' style='width: 100px; '></center></td></tr></tbody></table></form>");
           //다이얼 로그 생성
          ...
          $(document).on('click',"#constraint"+ tableNumber +"_"+ colNumber ,function() {
           ...
           /* 클릭시 컬럼 추가 */
             $(document).on('click',"#plus"+tableNumber ,function() {
               ...
               //컬럼을 추가 한다
               $(this).parent().parent().parent().parent().append("<tr><td><input type='text' name='col"+ tableNumber +"_"+ ++colNumber +"'></td><td><input type='text' name='col_data"+ tableNumber +"_"+ colNumber +"'></td><td id='cons'><input type='button' id='constraint"+ tableNumber +"_"+ colNumber +"' name='constraint' value='제약설정'><input type='hidden' id='conhidden' value='constraintDialog"+ tableNumber +"_"+ colNumber +"'><input type='hidden' id='conhidden_hidden' value='constraintDialog_Dialog"+ tableNumber +"_"+ colNumber +"'><input type='hidden' id='constraints' value=''><input type='hidden' id='hidden_tableName' value=''><input type='hidden' id='hidden_colName' value=''></td></tr>");
   ...
   <div id="page-wrapper">
      <div class="row">
         <div class="col-lg-12">
            ...
            <tr id='colplus'><td><img id="colimg" name="colimg" src="<%=request.getContextPath()%>/resources/img/1.jpg"><input type='text' name='col"+ tableNumber +"_"+ colNumber +"'></td><td><input type='text' name='col_data"+ tableNumber +"_"+ colNumber +"'></td><td id='cons'><input type='button' id='constraint"+ tableNumber +"_"+ colNumber +"' name='constraint' value='제약설정'><input type='hidden' id='conhidden' value='constraintDialog"+ tableNumber +"_"+ colNumber +"'><input type='hidden' id='conhidden_hidden' value='constraintDialog_Dialog"+ tableNumber +"_"+ colNumber +"'><input type='hidden' id='constraints' value=''><input type='hidden' id='hidden_tableName' value=''><input type='hidden' id='hidden_colName' value=''></td></tr>
