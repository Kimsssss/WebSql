       ...
       $( "#sections" ).droppable({
         ...
         accept: "#createtable",
          drop: function( event, ui ) {
           ...
           //테이블 생성
           $( this ).prepend("<form action='create.htm' method='post'><table border='1' id='tbs' class='draggable table table-striped table-bordered table-hover'><tbody><tr><td colspan='3'><input type='text' name='tablename"+ tableNumber +"' placeholder='테이블명'></td></tr>   <tr><td>컬럼명</td><td>데이터 타입</td><td>제약조건</td></tr><tr><td><img id='colimg' name='colimg' src='<%=request.getContextPath()%>/resources/img/2.jpg'><input type='text' name='col"+ tableNumber +"_"+ colNumber +"'></td><td><input type='text' name='col_data"+ tableNumber +"_"+ colNumber +"'></td><td id='cons'><input type='button' id='constraint"+ tableNumber +"_"+ colNumber +"' name='constraint' value='제약설정'><input type='hidden' id='conhidden' value='constraintDialog"+ tableNumber +"_"+ colNumber +"'><input type='hidden' id='conhidden_hidden' value='constraintDialog_Dialog"+ tableNumber +"_"+ colNumber +"'><input type='hidden' id='constraints' value=''><input type='hidden' id='hidden_tableName' value=''><input type='hidden' id='hidden_colName' value=''></td></tr><tr><td colspan='3'><center><input id='sub"+ tableNumber +"' type='button' value='전송' style='width: 100px;'> <input type='button' id='plus"+ tableNumber +"' value='추가' style='width: 100px; '><input type='hidden' value='"+colNumber+"' id='ta_col_"+tableNumber+"'></center></td></tr></tbody></table></form>");
           //다이얼 로그 생성
   ...
   <div id="page-wrapper">
      <div class="row">
         <div class="col-lg-12">
            ...
            <input type="button" value="전체저장" id="allSave" name="allSave" class="btn btn-primary"> 
            <br><br>
            </header>
