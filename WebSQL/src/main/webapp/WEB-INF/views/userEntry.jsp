...
<body>
	...
	<div id="page-wrapper">
		...
		<div class="row">
			<div class="body">
				<h2 align="left" class="page-header">&nbsp;&nbsp;&nbsp;&nbsp;유저
					등록 화면</h2>
			</div>
      ...
      <font color="red"><c:forEach items="${errors.globalErrors}"
         ...
         <spring:message code="${error.code}" />
                        ...
                        <td><form:input class="form-control" path="enabled"
                              maxlength="50" value="0" readonly="true"/></td>
					...
					<div class="modal-dialog">
						...
						<div class="modal-content">
							...
							<form action="Mailsave.html" method="post"
								...
								<div align="center" class="modal-body" id="modalbody">
									...
									<input type="hidden" id="enabledhidden" name="enabledhidden"
										...
										name="pwdhidden2" value="">

									<table style="width: 310px;">
										<tr height="40px">
											<td><input type="text" class='form-control'
												id="modalemail" name="modalemail"></td>
											<td align="right">
												<button type="button" class="btn btn-outline btn-primary"
													id="modalbtn" name="modalbtn">인증코드전송</button>
											</td>
										</tr>
									</table>
